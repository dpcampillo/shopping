...
/**
 * Prueba de integracion de las preordenes
 * @author Usuario
 *
 */
...
public class PreOrderControllerIntegrationTest {
	...
	@Test
	public void givenPreOrdersWhenGetPreOrderThenStatus200() throws Exception {
		createPreOrder();
		mvc.perform(get("/api/preorders").contentType(MediaType.APPLICATION_JSON).header("Authorization",
				"Bearer " + getToken("admin"))).andExpect(status().isOk())
